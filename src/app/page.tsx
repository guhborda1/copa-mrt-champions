            ...
            >
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {pos !== 1 && (
                    <span className="text-[10px] text-muted-foreground">−{gap} pts do líder</span>
                  )}
                  {pos === 1 && (
                    <span className="text-[10px] uppercase tracking-widest text-gold inline-flex items-center gap-1">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background:
                        pos === 1
                          ? 'var(--gradient-gold)'
                          : 'linear-gradient(90deg, oklch(0.55 0.18 145), oklch(0.78 0.16 110))',
              ...
              <div className="flex flex-col items-end gap-0.5">
                <span
                  className={`font-display text-lg md:text-xl tabular-nums ${pos === 1 ? 'gradient-text-gold' : 'text-foreground'}`}
                >
                  {r.points}
                </span>
  ...
  return (
    <div className="glass-card rounded-2xl p-5 md:p-6 grid gap-4 md:grid-cols-2 relative overflow-hidden">
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse at 30% 0%, oklch(0.88 0.18 95 / 18%), transparent 60%)',
        }}
      />
      <LeaderSlot
        label="Seleção líder"
  ...
  return (
    <div className="glass-card rounded-2xl p-5 md:p-6 relative overflow-hidden">
      <div
        className="absolute inset-0 -z-10 opacity-60"
        style={{
          background: 'radial-gradient(circle at 80% 20%, oklch(0.88 0.18 95 / 18%), transparent 60%)',
        }}
      />
      <div className="flex items-center gap-2 mb-3">
      ...
      <div className="font-display text-xl md:text-2xl gradient-text-gold truncate">{franchise?.name ?? '—'}</div>
      ...
      <div className="mt-3 pt-3 border-t border-white/10 text-xs text-muted-foreground">
        ...
        {seller && (
          <>
            {' '}
            · <span className="gradient-text-gold font-display">{seller.points}</span> pts
          </>
        )}
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative max-w-7xl mx-auto px-5 md:px-8 pt-8 md:pt-14 pb-10 text-center">
        <div
          className="absolute inset-x-0 top-0 h-[520px] -z-10 opacity-80 pointer-events-none"
          style={{
            background:
        ...
        <div className="mt-5 h-7 overflow-hidden">
          <p
            key={quoteIdx}
            className="text-sm md:text-base text-gold tracking-wide animate-in fade-in slide-in-from-bottom-2 duration-700"
          >
